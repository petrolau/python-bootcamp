...
# If you pass as the second argument a 0, 
# Python will raise a ZeroDivisionError, so if this function is invoked
# with a 0 as the value of num2, return the string 
...
def divide(num1,num2):
    try:
        resultado =(num1/num2)
    #caso coloque só um parametro ou dois tipos icoerentes. 
    except TypeError:
        print("Por favor, inpute dois números inteiros ou floats.")
